...
const oldArray = `apps={[
  ...
  { id: 'progress', name: 'Progress', icon: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="%233b82f6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>' },
...
const regex = /apps=\{\[\s*\{\s*id:\s*'overview'[\s\S]*?'theme'[\s\S]*?\}\s*\]\}/;
content = content.replace(regex, oldArray);
fs.writeFileSync('src/main.jsx', content);
console.log('Fixed apps array');
